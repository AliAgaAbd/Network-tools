            ...
            while (true)
            {
                ...
                switch (select)
                {
                    ...
                    case "HELP":
                        {
                            Console.Clear();
                            Console.WriteLine("\tping: This section will help you ping a specified host or IP or DNS; after typing ping command\n\tyou will enter the ping section and askes you to enter a host,IP or DNS\n\tafter entering that, program will ask you for number of pings you want to take\n\tyou can enter 0 to ping until you press End key on your keyboard;\n\tin the next step, program will ask you for ping interval\n\tthis number in millisecond will change the time between ping packets;\n\tin the final step, you will enter your high ping alert which sets the\n\tnumber that pings higher than this level will recorded in the High ping.csv file;\n\tafter completing ping, you will see two files in desktop named High ping.csv and All ping.csv\n\tthat they are contains all pings list and high pings that you set in step 4 befor ping\n\tand you will see a summery of test in this file;\n\t");
